        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(
              icon: Icon(selectedIndex == 0 ? Iconsax.chart5 : Iconsax.chart),
              label: 'Chat',
            ),
            BottomNavigationBarItem(
              icon: Icon(selectedIndex == 1 ? Iconsax.people5 : Iconsax.people),
              label: 'Users',
            ),
            BottomNavigationBarItem(
              icon: Icon(
                selectedIndex == 2 ? Iconsax.user5 : Iconsax.user,
              ),
              label: 'Profile',
            ),
          ],
